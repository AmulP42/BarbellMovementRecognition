...
plot_binary_outliers(dataset, col, "acc_x_outlier", True)
...
# Test Chosen Outlier Function on single column
col = "gyr_z"
dataset = mark_outliers_chauvenet(df, col)
...
for col in outlier_columns:
    for label in df["label"].unique():
        ...
        num_outliers = len(dataset) - len(dataset[col].dropna())
        print(f"Removed {num_outliers} from {col} for {label}")
