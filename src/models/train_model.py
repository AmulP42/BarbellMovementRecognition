...
# Create Subsets Based on Features
...
# Decision Tree to Identify 10 Best Features
...
# Grid Search to Identify Best Model and Parameter Pair
...
# Random Forest Proved to Perform the Best
(class_train_y,
class_test_y,
class_train_prob_y,
class_test_prob_y) = learner.random_forest(x_train[selected_features], y_train, x_test[selected_features], gridsearch=True)
...
# Confusion Matrix to Identify Errors
plt.figure(figsize=(10, 10))
...
# Train on Participants other than A, Test on Participant A
...
class_test_y,
class_train_prob_y,
class_test_prob_y) = learner.random_forest(x_train[feature_set_4], y_train, x_test[feature_set_4], gridsearch=True)
...
class_test_y,
class_train_prob_y,
class_test_prob_y) = learner.feedforward_neural_network(x_train[selected_features], y_train, x_test[selected_features], gridsearch=False)
